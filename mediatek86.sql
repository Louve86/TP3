...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 07 mai 2022 à 11:04
...
-- Fonctions
--
DROP FUNCTION IF EXISTS `abonnementsEnDessousTrenteJours`$$
CREATE DEFINER=`root`@`localhost` FUNCTION `abonnementsEnDessousTrenteJours` () RETURNS TEXT CHARSET utf8 BEGIN
...
ALTER TABLE `utilisateur`
  ADD CONSTRAINT `utilisateur_ibfk_1` FOREIGN KEY (`service`) REFERENCES `service` (`id`);
COMMIT;
